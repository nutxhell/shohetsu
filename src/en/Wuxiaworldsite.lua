-- {"id":1281,"ver":"2.0.4","libVer":"1.0.0","author":"nutxhell"}

local baseURL = "https://www.https://wuxiaworld.site/"
local encoding = ""
...
return {
	...
	baseURL = baseURL,
	imageURL = "https://github.com/shosetsuorg/extensions/raw/dev/icons/WuxiaWorldsite.png",
	hasSearch = true,
	listings = {
